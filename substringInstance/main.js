...
function countOccurrences(full_text, search_text) {
    let count = 0;
    let index = 0;

    while ((index = full_text.indexOf(search_text, index)) !== -1) {
        count++;
...
console.log(countOccurrences("liamiscoolisdopeiscraycray", "is"));