...
function distancesFromAverage(arr) {
    ...
    // Map the array to calculate the difference from the average and round to two decimal places
    let differences = arr.map(number => {
        return Math.round((average-number) * 100) / 100;
    });
...
// Test the function
let result = distancesFromAverage([55, 95, 62, 36, 48]);
console.log(result); // Output: [4.2, -35.8, -2.8, 23.2, 11.2]
